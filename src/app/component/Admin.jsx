...
const AdminDashboard = () => {
  ...
  const bookingColumns = [
    ...
    { title: "Amount", dataIndex: "amount", render: (v) => `₹${v}` },
    {
      ...
      render: (s) => (
        <Tag
          color={s === "completed" ? "green" : s === "paid" ? "blue" : "gold"}
        >
          {s}
        </Tag>
      ),
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      <Row className="h-screen">
        ...
        <Col
          xs={24}
          md={5}
          className="bg-gradient-to-b from-red-500 to-red-600 dark:from-red-900 dark:to-red-950 shadow-2xl min-h-screen p-6 border-r dark:border-gray-700 overflow-y-auto"
        >
        ...
        <Col
          xs={24}
          md={19}
          className="p-8 bg-gray-50 dark:bg-gray-900 overflow-y-auto"
        >
          {/* ---- STATS ---- */}
          <Row gutter={[24, 24]} className="mb-10">
            <Col xs={24} sm={8}>
              ...
              >
                <Statistic
                  title={
                    <span className="dark:text-blue-200">Total Services</span>
                  }
            ...
            <Col xs={24} sm={8}>
              ...
              >
                <Statistic
                  title={
                    <span className="dark:text-green-200">Total Stores</span>
                  }
                  value={stores.length}
                  prefix={
                    <ShopOutlined className="text-green-600 dark:text-green-400" />
                  }
                  valueStyle={{
                    color: "#16a34a",
                    fontSize: "2rem",
            ...
            <Col xs={24} sm={8}>
              ...
              >
                <Statistic
                  title={
                    <span className="dark:text-purple-200">Total Bookings</span>
                  }
              ...
              >
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-green-100 to-green-50 dark:from-green-900 dark:to-green-800 p-6 rounded-xl mb-6 border-2 border-green-300 dark:border-green-600 shadow-md">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300 mb-5 ml-8">
                      Choose which vehicles this service applies to and set the
                      price for each
                    </p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6 ml-2">
                      {vehicleTypeOptions.map((v) => (
                        <div
                          key={v.value}
                          className="bg-white dark:bg-gray-700 p-4 rounded-xl border-2 border-green-200 dark:border-green-600 hover:border-green-400 hover:shadow-lg transition-all duration-200 cursor-pointer"
                        >
                          <label className="flex items-start gap-3 cursor-pointer">
                            <input
                              ...
                              onChange={(e) => {
                                const currentTags =
                                  serviceForm.getFieldValue("vehicleTags") ||
                                  [];
                                if (e.target.checked) {
                                  serviceForm.setFieldValue("vehicleTags", [
                                    ...currentTags,
                                    v.value,
                                  ]);
                                } else {
                  ...
                  <div className="bg-gradient-to-r from-purple-100 to-purple-50 dark:from-purple-900 dark:to-purple-800 p-6 rounded-xl mb-6 border-2 border-purple-300 dark:border-purple-600 shadow-md flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300 ml-8">
                        Enable this service for customer bookings
                      </p>
                    </div>
                    <Form.Item
                      name="isActive"
                          ...
                          <div className="flex items-center gap-2 flex-wrap justify-end">
                            {item?.prices &&
                              Object.entries(item.prices)
                                ...
                                .map(([key, val]) => (
                                  <Tag key={key} color="blue" className="mr-0">
                                    {key.toUpperCase()} ₹{val}
                                  </Tag>
                                ))}
                            {(!item?.prices ||
                ...
                <Form form={storeForm} layout="vertical" onFinish={onAddStore}>
                  ...
                  >
                    <Input
                      ...
                      className="h-11 text-base font-semibold bg-gray-100 dark:bg-gray-600 text-gray-900 dark:text-white border-gray-300 dark:border-gray-500 placeholder-gray-500 dark:placeholder-gray-300"
                    />
                  </Form.Item>
                    ...
                    <Col xs={24} sm={12}>
                      ...
                      >
                        <InputNumber
                          ...
                          step={0.0001}
                          className="h-11 w-full text-base font-semibold bg-gray-100 dark:bg-gray-600 text-gray-900 dark:text-white border-gray-300 dark:border-gray-500"
                        />
                      </Form.Item>
                    </Col>
                    <Col xs={24} sm={12}>
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6">
          <Form form={serviceForm} layout="vertical" onFinish={onEditService}>
            ...
            <div className="bg-gradient-to-r from-green-100 to-green-50 dark:from-green-900 dark:to-green-800 p-6 rounded-xl mb-6 border-2 border-green-300 dark:border-green-600 shadow-md">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-5 ml-8">
                Choose which vehicles this service applies to and set the price
                for each
              </p>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (e.target.checked) {
                            ...
                            serviceForm.setFieldValue(
                              "vehicleTags",
                              currentTags.filter((tag) => tag !== v.value),
                            );
                          }
                        }}
                        className="w-5 h-5 rounded cursor-pointer mt-1 accent-green-500"
